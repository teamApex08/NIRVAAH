...
export function PortfolioRisk() {
  return (
    <Card>
      <CardHeader>
        <h2 className="text-lg font-black text-[#0b2545]">Portfolio Risk</h2>
        <p className="mt-1 text-sm text-[#526276]">42 projects assessed</p>
      </CardHeader>
      <CardBody>
        <strong className="block text-5xl font-black leading-none text-[#0b2545]">19</strong>
        ...
        <ul className="mt-5 grid gap-3">
          {riskDistribution.map((item) => (
            <li className="grid grid-cols-[12px_1fr_auto] items-center gap-2 text-sm text-[#263d59]" key={item.label}>
              ...
              <strong className="font-black text-[#0b2545]">
